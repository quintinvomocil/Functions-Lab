...
//CODE HERE
// This is longer than it nedds to be
...
//This is the same function just with simplier syntax and easier to understand
...
//This is the same funtions with simplier syntax
...
// REMEMBER THAT WHEN YOU WANT TO PULL THE INPUT OF A FUNCTION INTO THE FUNCTION YOU
...
const nameGreeting = nameCheck('Q')
    ...
    if (color === "red"){
      return 'Red is a great color.'
         ...
         return "Green is a solid favorite color."
          ...
          return "You need to elevate your favorite color choice."
    }
  }

  let colorRating = faveColorFinder('Poop Brown')
...
let myMovie = bestMovie("Lord of the Rings")
...
/* 
  ...
  If the number is LESS than or EQUAL to 100, push 'small' as a string to the
  answers array. 
...
function bigOrSmall(arr){
  ...
  let arrayElevator = bigOrSmall(bigOrSmallArray)

  //console.log(arrayElevator)
////////////////// PROBLEM 16 ////////////////////

/*
  Write a function that is called theEliminator, which takes in two arguments, 
  contestants (which will each be an array of strings), and loser 
  (which will be a string).
...
function newSampleString(str) {
    console.log(str.toUpperCase())
}

  newSampleString(sampleString)
...
/*
  ...
  Your function should take in a single parameter, which is the amount of gold 
  you are willing to spend. 
  Your function should return a total amount of chocolate frogs you were 
  able to purchase.
  Create a variable called `totalFrogs` and 
  set it equal to your function invoked, 
  passing in the amount of gold you are willing to spend.
*/

//CODE HERE

let willingToSpend = 30

function howManyFrogsIGot(amounttospend){
    if(willingToSpend > 0){ 
      willingToSpend -= 3
  } return willingToSpend
}


// This just took 3 from the total and subtracted it one time.
// This is what the solutions came up with. I think I am making the problems to
// complicated. Just take a minute to find a simple solution.
...
/*
  ...
  ascending order. The function should return true, 
  if it is sorted in ascending order, false if it is not. 
  Create a variable, `arrayIsAscending` and set it equal to your
